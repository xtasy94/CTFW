...
function add_birds() {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        for (var j = 0; j < element.childNodes.length; j++) {
            ...
            if (node.nodeType === 3) {
                // Add a random bird with random probability
                ...
                if (birdIdentifier1.test(text) && birdIdentifier2.test(text) && birdIdentifier3.test(text)) {
                    thebird = [text.match(birdIdentifier1)[0], text.match(birdIdentifier2)[0], text.match(birdIdentifier3)[0]];
                    birdlist.push(thebird);
                }
                ...
                try {
                    var fixedText = document.createTextNode([text.slice(0, insertBirdHere), BIRDS[indexOfBird].slice(1), text.slice(insertBirdHere)].join(''));
                    element.replaceChild(fixedText, node);
                }
                catch (e) {
                    continue;
                }
